...
public class Owner implements ActionListener {
	...
	MenuItem item31 = new MenuItem("Migrate to other Cloud");
	...
	Owner(String username) {
		...
		c.setLayout(null);
		jf.setSize(660, 610);
		jf.setTitle(us+"->An Approach For Content Delivery In Cloud");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == verify) {
			...
			try {
				...
				System.out.println(message);
				JOptionPane.showMessageDialog(null, message);
				if(message.equalsIgnoreCase("Duplicate Filename Found in Cloud"))
				{
					int x = JOptionPane.showConfirmDialog(null, "Do you want to use this File in Cloud");
					if(x==0)
					{
						Socket soc11 = new Socket(ip, 102);
						DataOutputStream dos12 = new DataOutputStream(
								soc11.getOutputStream());
						dos12.writeUTF("link");
						dos12.writeUTF(filename);
						dos12.writeUTF(us);
						dos12.writeUTF(hash);
						
						DataInputStream din1 = new DataInputStream(soc11.getInputStream());
				...
				if(i==0)
				{
					...
					try {
						...
						if(message2.equalsIgnoreCase("Duplicate Filename Found in Cloud"))
						{
							int x = JOptionPane.showConfirmDialog(null, "Do you want to use this File in Cloud");
							if(x==0)
							{
								Socket soc12 = new Socket(ip2, 103);
								DataOutputStream dos12 = new DataOutputStream(
										soc12.getOutputStream());
								dos12.writeUTF("link");
								dos12.writeUTF(filename);
								dos12.writeUTF(us);
								dos12.writeUTF(hash);
								
								DataInputStream din1 = new DataInputStream(soc12.getInputStream());
								String message1 = din1.readUTF();
								JOptionPane.showMessageDialog(null, message1);
							}
							if(x==1)
						...
						if(i1==0)
						{
							...
							try {
								...
								if(message4.equalsIgnoreCase("Duplicate Filename Found in Cloud"))
								{
									int x = JOptionPane.showConfirmDialog(null, "Do you want to use this File in Cloud");
									if(x==0)
									{
										Socket soc13 = new Socket(ip3, 104);
										DataOutputStream dos12 = new DataOutputStream(
												soc13.getOutputStream());
										dos12.writeUTF("link");
										dos12.writeUTF(filename);
										dos12.writeUTF(us);
										dos12.writeUTF(hash);
										
										DataInputStream din1 = new DataInputStream(soc13.getInputStream());
										String message1 = din1.readUTF();
										JOptionPane.showMessageDialog(null, message1);
									}
									if(x==1)
					...
					try {
						...
						if(message3.equalsIgnoreCase("Duplicate Filename Found in Cloud"))
						{
							int x = JOptionPane.showConfirmDialog(null, "Do you want to use this File in Cloud");
							if(x==0)
							{
								Socket soc12 = new Socket(ip2, 104);
								DataOutputStream dos12 = new DataOutputStream(
										soc12.getOutputStream());
								dos12.writeUTF("link");
								dos12.writeUTF(filename);
			...
			try {
				...
				if(message.equalsIgnoreCase("Duplicate Filename Found in Cloud"))
				{
					...
					if(x==0)
					{
						Socket soc11 = new Socket(ip, 103);
						DataOutputStream dos12 = new DataOutputStream(
								soc11.getOutputStream());
						dos12.writeUTF("link");
						dos12.writeUTF(filename);
				...
				if(i==0)
				{
					...
					try {
						...
						if(message2.equalsIgnoreCase("Duplicate Filename Found in Cloud"))
						{
							...
							if(x==0)
							{
								Socket soc21 = new Socket(ip2, 102);
								DataOutputStream dos12 = new DataOutputStream(
										soc21.getOutputStream());
								dos12.writeUTF("link");
								dos12.writeUTF(filename);
								dos12.writeUTF(us);
								dos12.writeUTF(hash);
								
								DataInputStream din1 = new DataInputStream(soc21.getInputStream());
								String message1 = din1.readUTF();
								JOptionPane.showMessageDialog(null, message1);
							}
							if(x==1)
						...
						if(i1==0)
						{
							...
							try {
								...
								if(message4.equalsIgnoreCase("Duplicate Filename Found in Cloud"))
								{
									...
									if(x==0)
									{
										Socket soc31 = new Socket(ip3, 104);
										DataOutputStream dos12 = new DataOutputStream(
												soc31.getOutputStream());
										dos12.writeUTF("link");
										dos12.writeUTF(filename);
										dos12.writeUTF(us);
										dos12.writeUTF(hash);
										
										DataInputStream din1 = new DataInputStream(soc31.getInputStream());
										String message1 = din1.readUTF();
										JOptionPane.showMessageDialog(null, message1);
									}
									if(x==1)
					...
					try {
						...
						if(message3.equalsIgnoreCase("Duplicate Filename Found in Cloud"))
						{
							...
							if(x==0)
							{
								Socket soc21 = new Socket(ip2, 104);
								DataOutputStream dos12 = new DataOutputStream(
										soc21.getOutputStream());
								dos12.writeUTF("link");
								dos12.writeUTF(filename);
						...
						if(i1==0)
						{
							...
							try {
								...
								if(message4.equalsIgnoreCase("Duplicate Filename Found in Cloud"))
								{
									...
									if(x==0)
									{
										Socket soc31 = new Socket(ip3, 102);
										DataOutputStream dos12 = new DataOutputStream(
												soc31.getOutputStream());
										dos12.writeUTF("link");
										dos12.writeUTF(filename);
			...
			try {
				...
				if(message.equalsIgnoreCase("Duplicate Filename Found in Cloud"))
				{
					...
					if(x==0)
					{
						Socket soc11 = new Socket(ip, 104);
						DataOutputStream dos12 = new DataOutputStream(
								soc11.getOutputStream());
						dos12.writeUTF("link");
						dos12.writeUTF(filename);
				...
				if(i==0)
				{
						...
						if(i1==0)
						{
							...
							try {
								...
								if(message4.equalsIgnoreCase("Duplicate Filename Found in Cloud"))
								{
									...
									if(x==0)
									{
										Socket soc31 = new Socket(ip3, 103);
										DataOutputStream dos12 = new DataOutputStream(
												soc31.getOutputStream());
										dos12.writeUTF("link");
										dos12.writeUTF(filename);
					...
					try {
						...
						if(message3.equalsIgnoreCase("Duplicate Filename Found in Cloud"))
						{
							...
							if(x==0)
							{
								Socket soc21 = new Socket(ip2, 103);
								DataOutputStream dos12 = new DataOutputStream(
										soc21.getOutputStream());
								dos12.writeUTF("link");
								dos12.writeUTF(filename);
...
//cs1 completed			
				 ...
				 long end=System.currentTimeMillis();
					...
					Statement stmt21 = c.createStatement();
					String sql2 = "insert into delay values('"+filename+"','Uploading File','"+time+"','"+dt+"')";
					 stmt21.executeUpdate(sql2);
