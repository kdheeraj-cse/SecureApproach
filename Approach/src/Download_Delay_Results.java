...
public class Download_Delay_Results {
  ...
  String status="Downloading File";
    	...
    	try
    	{
    		...
    		ResultSet rs=st.executeQuery("select * from delay1 where purpose='"+status+"'");
    		...
    		while(rs.next()==true)
    		{
    	        ...
    	        JFreeChart chart = ChartFactory.createBarChart(
    	                "An Approach For Content Delivery In Cloud", "Delay Time", "Total Delay",
    	                dataSet, PlotOrientation.VERTICAL, true, true, true);
    	        ChartFrame chartFrame=new ChartFrame("Different Transaction Download Delay Details",chart);
