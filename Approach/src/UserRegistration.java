...
{
	f = new JFrame("Remote User Registeration::An Approach For Content Delivery In Cloud");
	p= new JPanel();
	p.setLayout(null);
	...
	if(ae.getSource()==b1)
	{
		...
		if(cloudname.equalsIgnoreCase("CS1"))
		{
			...
			if(res.equalsIgnoreCase("Success"))
			{
				...
				JOptionPane.showMessageDialog(null, "Note Down your Password:" + din.readUTF());
			}
		...
		{	
			...
			{
				JOptionPane.showMessageDialog(null,"Registered Successfully");
				JOptionPane.showMessageDialog(null, "Note Down your Password:" + din5.readUTF());
			}
